...
def main():
    ...
    p.add_argument("--study", choices=("layouts", "fusion"), default="layouts")
    a = p.parse_args()
    ...
    if a.study == "layouts":
        ...
        variants = {
            ...
            "permuted_queue": ((1, 2, 0), 0, "0"),
            "permuted_fused": ((1, 2, 0), 0, "1"),
            "permuted_fused_pad32": ((1, 2, 0), abi.CUDA_FIELD_PAD32, "1"),
            "permuted_fused_pad64": ((1, 2, 0), abi.CUDA_FIELD_PAD64, "1"),
        }
    executables = {}
