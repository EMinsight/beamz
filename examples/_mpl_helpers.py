...
def _snapshot_figure(snapshot, *, cmap, clean_visualization, interpolation, figure=None, axes=None, vmin=None, vmax=None):
...
def save_snapshot_video(
    ...
    *,
    ...
    fig, ax = plt.subplots(figsize=_snapshot_figsize(snapshots[0], clean_visualization=clean_visualization))
