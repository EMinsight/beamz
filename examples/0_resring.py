...
design = Design(width=6*µm, height=6*µm, material=Material(1), pml_size=WL/5)
design.add(Rectangle(position=(0,1*µm), width=6*µm, height=0.4*µm, material=Material(10)))
design.add(Ring(position=(3*µm, 3.35*µm), inner_radius=1.5*µm, outer_radius=1.9*µm, material=Material(10)))
